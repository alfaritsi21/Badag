          ...
          <nav>
            <b-row>
              ...
              <b-col v-if="isLogin2 === false" cols="6" md="6" sm="6">
                ...
                <b-button class="btn-sigin float-right">
                  <router-link to="/auth">Masuk</router-link>
                </b-button>-->
                <b-dropdown
                  id="dropdown-right"
                  right
          ...
          <div class="main-header">
            <b-row>
              <b-col cols="12" md="6" sm="6" class="header-left">
                ...
                <p>
                  BADAG Technology adalah situs Job Portal Digital, dimana
                  tempat untuk para Jobseeker mencari pekerjaan yang
                  berkualiatas.
                </p>
                <b-button class="btn-start" @click="onMulai"
      ...
      <section class="why">
        <b-row>
          <b-col cols="12" md="6" sm="6">
            <div class="why-img">
              <div class="rectangle-why"></div>
              <img src="../assets/img/img-landing/why-img.png" />
              <div class="rectangle-small-why"></div>
            </div>
          </b-col>
          <b-col cols="12" md="6" sm="6">
      ...
      <section class="skill">
        <b-row>
          <b-col cols="12" md="6" sm="6">
            <h2>Skill Tallent</h2>
            <p>
              Menyambut revolusi 4.0, Kami menyediakan tallent dengan berbagi
              skill yang Up To Date. Diantaranya :
            </p>
            <b-row>
              <b-col cols="6" md="6" sm="6">
                <p class="p">
          ...
          <b-col cols="12" md="6" sm="6">
            <div class="img-skill">
              <div class="rectangle-skill"></div>
              <img src="../assets/img/img-landing/skill-img.png" />
              <div class="rectangle-skill-small"></div>
            </div>
          </b-col>
        </b-row>
      </section>
      ...
      <section class="sign-now">
        <div class="banner">
          <b-row>
            ...
            <b-col cols="12" md="6" sm="6">
              <b-button class="btn-sign-now float-right" @click="onMulai"
                >Mulai Dari Sekarang</b-button
              >
            </b-col>
          </b-row>
